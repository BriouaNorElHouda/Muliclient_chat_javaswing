...
public class chat extends JFrame {
		...
		public void run() {
			while (true) {
				try {
					...
					System.out.println("processus de lecture  : " + m); 
					if (m.contains(":;.,/=")) { 
						m = m.substring(6); 
						dm.clear(); 
	...
	private void initialize() { 
		...
		clientdic.setBounds(12, 575, 193, 49);
